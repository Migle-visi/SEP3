...
public class RideLogic : IRideLogic
{
    ...
    public Task<List<Ride>> GetAllAsync(string? startDate, string? endDate, string userId)
    {
        ...
        return rideDao.GetAllAsync(startDateTime, endDateTime, epochNow, Int32.Parse(userId));
